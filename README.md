...
**ワークスペース構造:**
- このプロジェクトの親ディレクトリ全体がコンテナ内の `/home/<username>/workspace` にマウントされます
- 複数のプロジェクトを一つの開発環境で管理できます

```
親ディレクトリ/ (例: /home/shogo/work/)
├── workspace-docker/  ← Docker設定ファイル (このプロジェクト)
├── project-a/         ← Pythonプロジェクト
├── project-b/         ← Node.jsプロジェクト
└── project-c/         ← その他のプロジェクト
    ↓ マウント
